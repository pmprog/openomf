...
component *menu_connect_create(scene *s) {
    ...
    local->connect_button =
        textbutton_create(FONT_BIG, "CONNECT", "Connect to the provided IP address.", COM_ENABLED, menu_connect_start, s);
    local->cancel_button =
        textbutton_create(FONT_BIG, "CANCEL", "Exit from this menu.", COM_ENABLED, menu_connect_cancel, s);
